...
class Dragon(gym.Env):
    def __init__(self):
        ...
        self.hungry_dragon = [10, 10]  # Start Dragon at the center
    ...
    def render(self, mode='human'):
        ...
        dragon_image = pygame.transform.scale(dragon_image, (self.cell_size, self.cell_size))
        ...
        # Blit images
        self.screen.blit(dragon_image, (self.hungry_dragon[1] * self.cell_size, self.hungry_dragon[0] * self.cell_size))
